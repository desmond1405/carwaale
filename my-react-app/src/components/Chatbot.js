...
<div className={visible ? 'chatbot': 'chatbot active'}>{console.log(visible)}
    <div className='fixed  heads  text-center inline-block closer rounded-t-[10px] h-10 text-4xl z-50'>
      <div className='heading float-left text-gray-50 w-48 mt-2 h-6 text-xl'>CarWaale Assistant</div>
    ...
    <div className='con1'>
      ...
      <div className="messages">
            <div className="messagebot">
            <div className="bot q1 hover:cursor-pointer" onClick={() => send1('What is Apna Bot?')}>
            What is Apna Bot?

              </div>
              <div className="bot q1 hover:cursor-pointer" onClick={() => send1('What integrations are supported by Apna Bot?')}>
              Apna Bot integrations?
